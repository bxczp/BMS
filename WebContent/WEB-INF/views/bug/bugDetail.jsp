...
<style type="text/css">
	/* .panel:hover{
			...
			box-shadow: #999 10px 10px 10px 10px;
		} */
</style>
</head>
<body>
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div>
									<label for="" class="label label-default">${bug.categoryLabel}</label>
							</div>
						...
						<div class="col-md-4">
							<label for=""><spring:message code="Bug_Last_time" /></label>
							<div>
								<label for="" class="label label-default"><fmt:formatDate
...
<label for="" class="label label-default">${bug.priorityLabel}</label>
						...
						<div class="col-md-4">
							...
							<div>
								...
								<label for="" class="label label-default">${bug.osLabel}</label>
					...
					<div class="row">
						<div class="col-md-4">
							<label for=""><spring:message code="Bug_assign" /></label>
							<div>

	<label for="" class="label label-default">${bug.assigner}</label>
						...
						<div class="col-md-4">
							...
							<label for="" ><spring:message code="Bug_state" /></label>
							<div>

	<label for="" class="label label-danger">${bug.statusLabel}</label>
					...
					<div class="panel panel-primary">
						...
						<div class="form-group">
							...
							&nbsp;&nbsp;&nbsp;
							<button type="button" onclick="window.history.back()" class="btn btn-danger"><spring:message code="Bug_back" /></button>
					...
					<div class="panel-heading">
						<h5 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion"
								...
								class="glyphicon glyphicon-plus-sign"></span><spring:message code="Bug_feedback_history" />
							</a>
						</h5>
					</div>
					<div id="collapseOnes" class="panel-collapse collapse in">
						<div class="panel-body">
							<table class="table table-hover">
								<thead>
									<tr class="info">
										<th><spring:message code="Bug_date" /></th>
										<th><spring:message code="Bug_persion" /></th>
										<th><spring:message code="Bug_change_event" /></th>
								...
								<tbody>
									<c:forEach var="changelog" items="${changlogList}"
										...
										<tr>
											...
											<td class="success"><a href="${ctx}/user/getUserInfo?id=${changelog.userId}">${changelog.changeName }</a></td>
